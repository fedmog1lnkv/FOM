...
class app:
    ...
    def request_file(self):
        ...
        self.editor = filler("docx/shablon.docx")
    ...
    def page_3(self):
        ...
        self.compl1_evaluation_tool = ttk.Combobox(self.frame_table, values=self.values["forms"],
                                                   font=("Arial Bold", 13))
        ...
        self.compl2_evaluation_tool = ttk.Combobox(self.frame_table, values=self.values["forms"],
                                                   font=("Arial Bold", 13))
        ...
        self.compl3_evaluation_tool = ttk.Combobox(self.frame_table, values=self.values["forms"],
                                                   font=("Arial Bold", 13))
        ...
        self.back_table_btn = ttk.Button(self.frame_table, text="Назад по таблице",
                                         command=self.competence_to_interface_back)
        self.back_table_btn.place(relx=0.50, rely=0.91, relwidth=0.15)

        self.next_table_btn = ttk.Button(self.frame_table, text="Далее по таблице",
                                         command=self.competence_to_interface_next)
    ...
    def page_4(self):
        ...
        self.compl_tk = ttk.Combobox(self.frame_table, values=self.values["forms"], font=("Arial Bold", 13), height=10,
                                     width=7)
        self.compl_tk.grid(row=2, column=5, padx=3)

        self.compl_pa = ttk.Combobox(self.frame_table, values=self.values["forms"], font=("Arial Bold", 13), height=10,
                                     width=7)
        ...
        self.back_table_themes_btn = ttk.Button(self.frame_table, text="Назад по таблице",
                                                command=self.themes_table_back)
        self.back_table_themes_btn.place(relx=0.50, rely=0.91, relwidth=0.15)

        self.next_table_themes_btn = ttk.Button(self.frame_table, text="Далее по таблице",
                                                command=self.themes_table_next)
    ...
    def themes_table_next(self):
        if self.i < len(self.themes):
            self.themes[self.i]['indicators'] = [self.idks[i][0] for i in
                                                 self.compl_competence_indicators.curselection()]
            self.themes[self.i]['planned_result'] = [self.idks[i][1] for i in
                                                     self.compl_competence_indicators.curselection()]
    ...
    def page_5(self):
        ...
        for i in range(len(self.competences)):
            for j in range(len(self.competences[i]['indicators'])):
                self.competences[i]['indicators'][j] = (
                    self.competences[i]['indicators'][j][0], self.competences[i]['indicators'][j][1],
                    self.evalutions_tools[i][j])
